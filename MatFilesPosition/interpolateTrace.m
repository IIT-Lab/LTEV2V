...
if simParams.useLTE == true && simParams.positionTimeResolution<Tbeacon
    fprintf('The selected time resolution is smaller than the beacon period.\n');
    fprintf('In LTE-V2V, the resource allocation is performed on Tbeacon.\n');
...
interpFactor = ceil(deltaTorig/simParams.positionTimeResolution);
